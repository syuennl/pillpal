        ...
        builder: (context, snapshot) {
          ...
          return Column(
            children: [
              DashboardHeader(
                title: 'My Pillbox',
                subtitle: allMeds.length.toString() + ' medications',
                onAddPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: MedicationCategorySection(
                                  categoryName: 'SYRUPS',
                                  categoryIcon:
                                      MedicationType.syrup.outlinedIcon,
                              ...
                              Expanded(
                                child: MedicationCategorySection(
                                  ...
                                  categoryIcon:
                                      MedicationType.injection.outlinedIcon,
