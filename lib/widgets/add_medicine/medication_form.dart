...
class _MedicationFormState extends State<MedicationForm> {
  ...
  void initState() {
    ...
    if (med != null) {
      ...
      initialScheduledTimes = med.scheduledTimes.join(', ');
  ...
  void _handleSubmit() {
    ...
    if (name.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Please enter a medication name'),
    ...
    if (widget.isEditing) {
      final index = mockMedications.indexWhere(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            FormTextField(controller: _nameController),
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      FormTextField(controller: _dosageAmountController),
                    ],
                  ),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      _buildSubText('Unit'),
                      FormTextField(controller: _dosageUnitController),
                    ],
                  ),
                ),
              ],
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      _buildSubText('Value'),
                      FormTextField(controller: _strengthValueController),
                    ],
                  ),
                ),
                const SizedBox(width: 16),
            ...
            FormTextField(controller: _quantityController),
            const SizedBox(height: 10),
            ...
            FormTextField(controller: _scheduledTimesController),
            const SizedBox(height: 10),
